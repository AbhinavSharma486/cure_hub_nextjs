      ...
      >
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            name="address"
            label="Address"
            placeholder="8/429 Patti Chaudhran Kanisk vihar Baraut (Bagpat) Uttar Pradesh 250611"
          />
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            placeholder="LIC (Life Insurance Corporation of India)"
          />
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            placeholder="Atopic dermatitis or eczema"
          />
